...
class StartVideo extends Component {
  ...
  keywordprocessing = () => {
    alert("query based processing presses ");
  ...
  render() {
    ...
    return (
      <React.Fragment >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >  Similarity Based Processing</Button>


                  <Button
                    onClick={this.keywordprocessing}
                    color='primary'
                    margin='normal'
                    style={{
                      margin: '1rem'
                  ...
                  >  keyword Based Processing</Button>
        ...
        <div style={{
          backgroundColor: "#4A96BA", margin: "1%", padding: "1%", width: "100%"
        }} >
          <div style={{
